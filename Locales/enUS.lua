-------------------------------------------------------------------------------------------------------------
--
-- SPP Legion Admin - A World of Warcraft in-game administration addon.
...
--[[General]]
  --[[Tooltips]]
    ["ma_IconHint"] = "|cffeda55fClick|r to open SPP Legion Admin. |cffeda55fShift-Click|r to reload the user interface.",
    ["tt_Default"] = "Move your cursor over an element to toggle the tooltip!",
    ["tt_LanguageButton"] = "Change the language and reload SPP Legion Admin.",
  --[[Control Labels]]
...
--[[GM tab]]
  --[[Name]]
    ["tabmenu_Main"] = "GM",
  --[[Tooltips]]
    ["tt_MainButton"] = "Toggle SPP Legion Admin mainframe.",
